    ...
    <div class="container-fluid">    
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route("usuarios.cadastra")}}" method="POST" class="form-horizontal">
                            @csrf
                            
                            
                                <div class="row">
                                    <div class="col-12 d-flex no-block align-items-center">
                                        <h5 class="card-title m-b-0"><b>Cadastrar Usuário</b></h5>
                                                                                                                        
                                    
                                        <div class="ml-auto text-right">
                                            <a href="{{ route('usuarios') }}" class="btn btn-info ml-1"><i class="fas fa-arrow-left"></i> Voltar</a>                                            
                                            <button type="submit" class="btn btn-info ml-1">Cadastrar</button>      
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    <label>Senha <small class="text-muted">(obrigatório) (A senha deverá conter entre 7 e 9 caracteres alfanuméricos)</small></label>
                                    <div class="row mb-3">
                                        <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tipo" id="tipo" class="form-control select2 {{ $errors->has('tipo')?'is-invalid':'' }}" style="width: 100%; height:36px;">      
                                        ...
                                        <option value="1" {{ "1"== old('tipo')?'selected="selected"':'' }} >Administrador</option> 
                                        <option value="2" {{ "2"== old('tipo')?'selected="selected"':'' }} >Auxiliar</option>                                                
                                    </select>
